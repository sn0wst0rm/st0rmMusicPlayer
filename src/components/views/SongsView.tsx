                        ...
                        components={{
                            Header: () => (
                                <div className="flex flex-col">
                                    <TableHeaderContent />
                                    <div className="sticky top-[56px] z-20 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b shadow-sm transition-shadow duration-200">
