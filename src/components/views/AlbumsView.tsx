...
export function AlbumsView({ groupedAlbums, playAlbum, onSelectAlbum, albumsComponents, onScroll, virtuosoRef, onRangeChanged }: AlbumsViewProps) {
    return (
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-6 mt-4 px-8">
                                    ...
                                    {group.albums.map((album: any) => (
                                        <AlbumCard key={album.id} album={album} playAlbum={playAlbum} onSelect={onSelectAlbum} artistName={album.artistName} />
                                    ))}
                                </div>
                            </div>
                        )}
